                ...
                <form
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ config('w-auth.test.sign-up.name', 'John Doe') }}"
                            @endif
                            @endif
                            placeholder="{{ __('sign-up.name.placeholder') }}"
                            @if (config('app.env', 'production' )==='production' )
                            required="on"
                            autocomplete="off"
                            @endif
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            @else
                            @if (config('app.env', 'production' ) !=='production' )
                            value="{{ config('w-auth.test.sign-up.email', 'john.doe@email.com') }}"
                            @endif
                            @endif
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            @else
                            @if (config('app.env', 'production' ) !=='production' )
                            value="{{ config('w-auth.test.sign-up.password', 'Password1234.') }}"
                            @endif
                            @endif
                            placeholder="••••••••••••"
                            @if (config('app.env', 'production' )==='production' )
                    ...
                    @php $captcha_message = '' @endphp
                    @for ($i = 1; $i <= config('w-auth.security.captcha.value', 6); $i++)
                    @if (session('captcha_' . $i) && $captcha_message === '')
                    @foreach (session('captcha_' . $i) as $message)
                    @php $captcha_message = $message; @endphp
                    @endforeach
                    @endif
                    @endfor
                    <x-captcha-component show-error="{{ $captcha_message ? true : false }}" />
                    <p class="form-input-message">
                        {{ $captcha_message }}
                    </p>
                    @endif
                        ...
                        <div class="checkbox">
                            <div class="checkbox-wrapper">
                                <input
                                    ...
                                    @else
                                    @if (config('app.env', 'production' ) !=='production' )
                                    value="{{ config('w-auth.test.sign-up.terms', true) }}"
                                    @endif
                                    @endif
                        ...
                        <div class="checkbox">
                            <div class="checkbox-wrapper">
                                <input
                                    ...
                                    @else
                                    @if (config('app.env', 'production' ) !=='production' )
                                    value="{{ config('w-auth.test.sign-up.policy', true) }}"
                                    @endif
                                    @endif
